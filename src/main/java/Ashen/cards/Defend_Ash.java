...
public class Defend_Ash extends CustomCard {
    ...
    // Heya! I've had a look at the docs and other mods~ So apparently this function gets the card strings
    // From a localization JSON file~ I've added one in resources/localization/eng!
    // You can use this variable at some point if you want :3
    // ~ Justin aka Cipher
